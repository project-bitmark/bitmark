...
WORKINGDIR="/tmp/bitmark"
TMPFILE="hashes.tmp"

#this URL is used if a version number is not specified as an argument to the script
SIGNATUREFILE="http://downloads.sourceforge.net/project/bitmark/Bitmark/bitmark-0.9.0rc1/SHA256SUMS.asc"

SIGNATUREFILENAME="SHA256SUMS.asc"
RCSUBDIR="test/"
BASEDIR="http://downloads.sourceforge.net/project/bitmark/Bitmark/"
VERSIONPREFIX="bitmark-"
RCVERSIONSTRING="rc"
...
if [ -n "$1" ]; then
   #let's also check if the version number includes the prefix 'bitmark-',
...
if [ $? -ne 0 ]; then
   ...
   echo "[bitmark-]<version>-[rc[0-9]] (example: bitmark-0.7.1-rc1)"
   echo "wget output:"
