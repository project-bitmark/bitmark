...
*Setup instructions for a gitian build of Bitmark using a Debian VM or physical system.*

Gitian is the deterministic build process that is used to build the Bitmark
...
- [Building Bitmark](#building-bitmark)
...
Clone the git repositories for bitmark and gitian,

```bash
git clone https://github.com/devrandom/gitian-builder.git
git clone https://github.com/bitmark/bitmark
```
...
In [doc/release-process.md](release-process.md) in the bitmark repository under 'Fetch and build inputs'.
...
To build Bitmark (for Linux and/or Windows) just follow the steps under 'perform
gitian builds' in [doc/release-process.md](release-process.md) in the bitmark repository.

Output from `gbuild` will look something like

    Initialized empty Git repository in /home/debian/gitian-builder/inputs/bitmark/.git/
    remote: Reusing existing pack: 35606, done.
    remote: Total 35606 (delta 0), reused 0 (delta 0)
    Receiving objects: 100% (35606/35606), 26.52 MiB | 4.28 MiB/s, done.
    Resolving deltas: 100% (25724/25724), done.
    From https://github.com/bitmark/bitmark
...
For example:
```bash
URL=https://github.com/laanwj/bitmark.git
COMMIT=2014_03_windows_unicode_path
./bin/gbuild --commit bitmark=${COMMIT} --url bitmark=${URL} ../bitmark/contrib/gitian-descriptors/gitian-linux.yml
./bin/gbuild --commit bitmark=${COMMIT} --url bitmark=${URL} ../bitmark/contrib/gitian-descriptors/gitian-win.yml
```
...
```bash
    gpg --detach-sign ${VERSION}/${SIGNER}/bitmark-build.assert
    gpg --detach-sign ${VERSION}-win/${SIGNER}/bitmark-build.assert
```
...
[bitmark/gitian.sigs](https://github.com/bitmark/gitian.sigs/) repository, or
