Bitmark Core version 0.9.2 is now available from:

  https://bitmark.org/bin/0.9.2/
...
Please report bugs using the issue tracker at github:
  ...
  https://github.com/bitmark/bitmark/issues
...
installer (on Windows) or just copy over /Applications/Bitmark-Qt (on Mac) or
bitmarkd/bitmark-qt (on Linux).
...
- Fix "Start bitmark on system login"
