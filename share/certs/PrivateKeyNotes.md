...
unlocked to sign the Bitmark-Qt.app bundle.
...
allowing somebody to distribute a Bitmark-Qt.app or bitmark-qt-setup.exe with a valid
...
that the bitmark-qt.exe file inside the installer had not been tampered with.
