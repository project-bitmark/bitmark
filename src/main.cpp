...
int64_t GetBlockValue(CBlockIndex* pindexPrev, int64_t nFees, bool scale)
{
    ...
    /*    else if (scale&&pindexPrev->nHeight!=0) {
    ...
    if (RegTest()) return nFees + (int64_t)std::floor(1500000000. * (1.+scalingFactor)*0.5+0.5);

    // Generated by generate_emitted_points.py
    if (emitted < 788000000000000)  {// Q 1 H 0 height 394000
      return nFees + (int64_t)std::floor(2000000000. * (1.+scalingFactor)*0.5+0.5);
    }
    if (emitted < 1379000000000000) { // Q 1 H 1 height 788000
      return nFees + (int64_t)std::floor(1500000000. * (1.+scalingFactor)*0.5+0.5);
    }
    if (emitted < 1773000000000000)  // Q 2 H 1 height 1182000
      return nFees + (int64_t)std::floor(1500000000. * (1.+scalingFactor)*0.5+0.5);
    if (emitted < 2068500000000000)  // Q 2 H 2 height 1576000
      return nFees + (int64_t)std::floor(750000000. * (1.+scalingFactor)*0.5+0.5);
    if (emitted < 2265500000000000)  // Q 3 H 2 height 1970000
      return nFees + (int64_t)std::floor(500000000. * (1.+scalingFactor)*0.5+0.5);
    if (emitted < 2413250000000000)  // Q 3 H 3 height 2364000
      return nFees + (int64_t)std::floor(375000000. * (1.+scalingFactor)*0.5+0.5);
    if (emitted < 2511750000000000)  // Q 4 H 3 height 2758000
      return nFees + (int64_t)std::floor(250000000. * (1.+scalingFactor)*0.5+0.5);
    if (emitted < 2585625000000000)  // Q 4 H 4 height 3152000
      return nFees + (int64_t)std::floor(187500000. * (1.+scalingFactor)*0.5+0.5);
    if (emitted < 2634875000000000)  // Q 5 H 4 height 3546000
      return nFees + (int64_t)std::floor(125000000. * (1.+scalingFactor)*0.5+0.5);
    if (emitted < 2671812500000000)  // Q 5 H 5 height 3940000
      return nFees + (int64_t)std::floor(93750000. * (1.+scalingFactor)*0.5+0.5);
    if (emitted < 2696437500000000)  // Q 6 H 5 height 4334000
      return nFees + (int64_t)std::floor(62500000. * (1.+scalingFactor)*0.5+0.5);
    if (emitted < 2714906250000000)  // Q 6 H 6 height 4728000
      return nFees + (int64_t)std::floor(46875000. * (1.+scalingFactor)*0.5+0.5);
    if (emitted < 2727218750000000)  // Q 7 H 6 height 5122000
      return nFees + (int64_t)std::floor(31250000. * (1.+scalingFactor)*0.5+0.5);
    if (emitted < 2736453125000000)  // Q 7 H 7 height 5516000
      return nFees + (int64_t)std::floor(2347500. * (1.+scalingFactor)*0.5+0.5);
    if (emitted < 2742609375000000)  // Q 8 H 7 height 5910000
      return nFees + (int64_t)std::floor(15625000. * (1.+scalingFactor)*0.5+0.5);
    if (emitted < 2747226562500000)  // Q 8 H 8 height 6304000
      return nFees + (int64_t)std::floor(11718750. * (1.+scalingFactor)*0.5+0.5);
    if (emitted < 2750304687500000)  // Q 9 H 8 height 6698000
      return nFees + (int64_t)std::floor(7812500. * (1.+scalingFactor)*0.5+0.5);
    if (emitted < 2752613281250000)  // Q 9 H 9 height 7092000
      return nFees + (int64_t)std::floor(5859375. * (1.+scalingFactor)*0.5+0.5);
    if (emitted < 2754152343750000)  // Q 10 H 9 height 7486000
      return nFees + (int64_t)std::floor(3906250. * (1.+scalingFactor)*0.5+0.5);
    if (emitted < 2755306640428000)  // Q 10 H 10 height 7880000
      return nFees + (int64_t)std::floor(2929687. * (1.+scalingFactor)*0.5+0.5);
    if (emitted < 2756076171284000)  // Q 11 H 10 height 8274000
      return nFees + (int64_t)std::floor(1953124. * (1.+scalingFactor)*0.5+0.5);
    if (emitted < 2756653319426000)  // Q 11 H 11 height 8668000
      return nFees + (int64_t)std::floor(1464843. * (1.+scalingFactor)*0.5+0.5);
    if (emitted < 2757038084854000)  // Q 12 H 11 height 9062000
      return nFees + (int64_t)std::floor(976562. * (1.+scalingFactor)*0.5+0.5);
    if (emitted < 2757326658728000)  // Q 12 H 12 height 9456000
      return nFees + (int64_t)std::floor(732421. * (1.+scalingFactor)*0.5+0.5);
    if (emitted < 2757519041048000)  // Q 13 H 12 height 9850000
      return nFees + (int64_t)std::floor(488280. * (1.+scalingFactor)*0.5+0.5);
    if (emitted < 2757663327788000)  // Q 13 H 13 height 10244000
      return nFees + (int64_t)std::floor(366210. * (1.+scalingFactor)*0.5+0.5);
    if (emitted < 2757759518948000)  // Q 14 H 13 height 10638000
      return nFees + (int64_t)std::floor(244140. * (1.+scalingFactor)*0.5+0.5);
    if (emitted < 2757831662318000)  // Q 14 H 14 height 11032000
      return nFees + (int64_t)std::floor(183105. * (1.+scalingFactor)*0.5+0.5);
    if (emitted < 2757879757898000)  // Q 15 H 14 height 11426000
      return nFees + (int64_t)std::floor(122070. * (1.+scalingFactor)*0.5+0.5);
    if (emitted < 2757915829386000)  // Q 15 H 15 height 11820000
      return nFees + (int64_t)std::floor(91552. * (1.+scalingFactor)*0.5+0.5);
    if (emitted < 2757939876782000)  // Q 16 H 15 height 12214000
      return nFees + (int64_t)std::floor(61034. * (1.+scalingFactor)*0.5+0.5);
    if (emitted < 2757957912132000)  // Q 16 H 16 height 12608000
      return nFees + (int64_t)std::floor(45775. * (1.+scalingFactor)*0.5+0.5);
    if (emitted < 2757969935436000)  // Q 17 H 16 height 13002000
      return nFees + (int64_t)std::floor(30516. * (1.+scalingFactor)*0.5+0.5);
    if (emitted < 2757978952914000)  // Q 17 H 17 height 13396000
      return nFees + (int64_t)std::floor(22887. * (1.+scalingFactor)*0.5+0.5);
    if (emitted < 2757984964566000)  // Q 18 H 17 height 13790000
      return nFees + (int64_t)std::floor(15258. * (1.+scalingFactor)*0.5+0.5);
