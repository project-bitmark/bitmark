...
int64_t GetBlockValue(CBlockIndex* pindexPrev, int64_t nFees, bool scale)
{
    ...
    if (RegTest()) return nFees + 1500000000 - ((CBigNum(1500000000)*CBigNum(100000000))/scalingFactor).getuint();
    ...
    return nFees + baseSubsidy - (((CBigNum(baseSubsidy)*CBigNum(100000000))/scalingFactor)/2).getuint();
}
