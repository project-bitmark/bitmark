...
CBlockTemplate* CreateNewBlock(const CScript& scriptPubKeyIn, bool isAux = false);
CBlockTemplate* CreateNewBlockWithKey(CReserveKey& reservekey, bool isAux = false);
